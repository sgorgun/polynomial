    ...
    public class TestData
    {
        ...
        public static IEnumerable<TestCaseData> TestCasesForEquals
        {
            get
            {
                ...
                yield return new TestCaseData(new Polynomial(0.5), new Polynomial(0.49999999)).Returns(true);
                yield return new TestCaseData(new Polynomial(0, 0.1, 0.0001),
                        new Polynomial(0, 0.1, 0.00010091))
                    .Returns(true);
                yield return new TestCaseData(new Polynomial(-10.12300013, 5.89),
                        new Polynomial(-10.123, 5.89))
                    .Returns(true);
                yield return new TestCaseData(new Polynomial(1d, 2d, 3d), new Polynomial(1d, 2d, 3d)).Returns(true);
                yield return new TestCaseData(new Polynomial(0.5), new Polynomial(0.5000021)).Returns(true);
                ...
                yield return new TestCaseData(new Polynomial(-10.123, 5.89),
                        new Polynomial(-10.12300004, 5.89))
                    .Returns(true);
                ...
                yield return new TestCaseData(new Polynomial(-0.123, 0.0, -0.0),
                        new Polynomial(-0.123065, 0.0, -0.0))
                    .Returns(false);
        ...
        public static IEnumerable<TestCaseData> TestCasesForGetHashCode
        {
            get
            {
                ...
                yield return new TestCaseData(new Polynomial(0, 0.1, 0.0001),
                    new Polynomial(0, 0.1, 0.000100876));
                yield return new TestCaseData(new Polynomial(-10.1230000432, 5.89),
                    new Polynomial(-10.123, 5.89));
                yield return new TestCaseData(new Polynomial(1d, 2d, 3d), new Polynomial(1d, 2d, 3d - Double.Epsilon));
                yield return new TestCaseData(new Polynomial(0, 0.1, 0.0001), new Polynomial(0, 0.1, 0.0001));
                yield return new TestCaseData(new Polynomial(-10.123, 5.89),
                    new Polynomial(-10.123, 5.8900023));
            }
        }
